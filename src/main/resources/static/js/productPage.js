...
class ProductPage {
    ...
    renderProduct(product) {
        ...
        const buyFromWishlistBtn = document.createElement('button');
        buyFromWishlistBtn.className = 'btn btn-success';
        buyFromWishlistBtn.id = 'buyFromWishlistBtn';
        buyFromWishlistBtn.textContent = 'Buy';
        ...
        colDetailsDiv.appendChild(buyFromWishlistBtn);
